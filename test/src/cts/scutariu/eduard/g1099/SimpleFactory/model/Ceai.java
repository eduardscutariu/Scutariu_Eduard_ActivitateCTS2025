...
public class Ceai extends AbstractBautura implements Bautura,BauturaPresetata{

    private boolean topping;

    public Ceai(String nume, float volum, double pret) {
